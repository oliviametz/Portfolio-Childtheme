...
blue.addEventListener('click', () => setBackgroundColor('linear-gradient(rgb(143, 157, 176), rgb(216, 219, 234))'));
...
purple.addEventListener('click', () => setBackgroundColor('linear-gradient(rgb(156, 132, 173), rgb(217, 198, 234))'));
